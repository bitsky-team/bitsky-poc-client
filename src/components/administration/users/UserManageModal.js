...
export default class UserManageModal extends Component {
    ...
    checkRelationshipstatus = () => {
        return ['Célibataire', 'En couple', 'Marié(e)', 'Veuf(ve)', 'Non précisé'].includes(this.state.relationshipstatus)
    }
    ...
    checkForm = async () => {
        ...
        if (isFormOk) {
            ...
            if (success) {
                toast.success(`L'utilisateur ${this.state.firstname} ${this.state.lastname} a bien été ajouté !`, {
                    autoClose: 5000,
                        ...
                        <Row form>
                            <Col md={6}>
                                <FormGroup>
                                    ...
                                    <FormFeedback>La situation amoureuse est incorrecte</FormFeedback>
                                </FormGroup>
                            </Col>
                            <Col md={6}>
                                <FormGroup>
